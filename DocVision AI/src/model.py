...
def build_model(
    ...
    try:
        model = models.Sequential([
            ...
            layers.BatchNormalization(momentum=0.9, name="conv_block1_bn"),
            ...
            layers.BatchNormalization(momentum=0.9, name="conv_block2_bn"),
            ...
            layers.BatchNormalization(momentum=0.9, name="conv_block3_bn"),
